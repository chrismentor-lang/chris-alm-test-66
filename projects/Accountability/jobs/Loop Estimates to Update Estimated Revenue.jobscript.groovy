API.executeLoad("dAccountabilityEndpointEstimatedRevenue_100_010_attrIDs_fh");
DB = "cgLocal_statThinkerbellApplicationManagement_jc";
Cub = "#_Accountability Endpoint";
String [] path = ["IDs", 'EstimatedRevenue', "~"];
...
for (id in list) {
    ...
    API.setProperty("vEstimateID", id);
    ...
    API.executeLoad("jPut_000_000_statEstimateRevenue_jl");
