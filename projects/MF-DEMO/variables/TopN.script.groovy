...
try {
    ...
    def elem = dim.getElementByName("Actual")

    if (!elem) throw new FunctionException("Element 'Actual' not found in Version dimension.")

    def topNValue = elem.getAttributeValue("TopN Value")
